...
final readonly class ListMateriasDocente
{
    ...
    public function execute(int $docenteId, int $gestionId): array
    {
        return $this->asignaciones->listByDocenteAndGestion($docenteId, $gestionId);
    }
}
